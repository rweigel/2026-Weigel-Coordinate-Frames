...
%\add[r2]{and 2.5~km for the spacecraft of the Cluster mission \cite{Escoubet2021} at a radial distance of ${\sim}9.9$~$R_E$, which corresponds to ${\sim}0.002^\circ$.}}
...
\begin{figure}[htb]
    \vspace{-0.5cm}
    \includegraphics[width=1.1\textwidth]{figures/combined/figure1}
...
\begin{figure}[h]
    \vspace{-0.5cm}
    \includegraphics[width=1.1\textwidth]{figures/combined/figure2}
...
\begin{figure}[htb]
    \vspace{-0.65cm}
    \includegraphics[width=\textwidth]{figures/combined/figure3}
...
%For example, \citeA{Russell1971}, \citeA{Kivelson1995}, and \citeA{Russell2016} provide a Fortran program for computing Greenwich Mean Sidereal Time (GMST) that differs from that in \citeA{Hapgood1992} and \citeA{Franz2002}. We find that the angular differences of the latter two on 2020-01-01T00:00:00 are ${\sim }0.001^\circ$.}

%\add[r2]{\citeA{Hapgood1992} and \citeA{Franz2002} both use a formula for GMST based on the 1982 IAU definition of UT1 \cite{Meeus1998}; \citeA{Hapgood1992} uses a version with higher-order terms omitted, and \citeA{Franz2002} uses the full form but with small differences in the coefficients from \cite{Meeus1998}. Another important consideration is that \citeA{Hapgood1992} and \citeA{Franz2002} use a formula based on the 1982 IAU definition of UT1 (\citeA{Meeus1998}; \citeA{Aoki1982}), and the equation based on the more recent 2000 IAU definition of UT1 differs \cite{Capitaine2003}.}
