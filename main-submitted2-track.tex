...
\begin{itemize}
    ...
    \item \texttt{ECI} -- Earth Centered Inertial; used in \citeA{MMS2024} with the note ``\texttt{GEI/J2000} – Earth-Centered Inertial (\texttt{ECI}). To fully specify the system the equinox must be defined. This system uses the mean equinox at the J2000 epoch."
